...
#Number of milisecs to wait between resending IDEX message without response
export PFE_CFG_IDEX_RESEND_TIME?=100
#Number of times to send IDEX request
export PFE_CFG_IDEX_RESEND_COUNT?=10
...
ifneq ($(PFE_CFG_MULTI_INSTANCE_SUPPORT),0)
    ...
    GLOBAL_CCFLAGS+=-DPFE_CFG_IDEX_RESEND_TIME=$(PFE_CFG_IDEX_RESEND_TIME)
    GLOBAL_CCFLAGS+=-DPFE_CFG_IDEX_RESEND_COUNT=$(PFE_CFG_IDEX_RESEND_COUNT)
